...
static pen_t color_table[COLOR_BUTTONS] =
{
	...
	BUTTON_COLOR_YELLOW,                      // DIR_...
	BUTTON_COLOR_YELLOW,                      // DIR_1
	BUTTON_COLOR_YELLOW,                      // DIR_2
	BUTTON_COLOR_YELLOW,                      // DIR_3
	BUTTON_COLOR_YELLOW,                      // DIR_4
	BUTTON_COLOR_RED,       // Joystick Ball
	BUTTON_COLOR_YELLOW,                      // DIR_6
	BUTTON_COLOR_YELLOW,                      // DIR_7
	BUTTON_COLOR_YELLOW,                      // DIR_8
	BUTTON_COLOR_YELLOW,                      // DIR_9
	BUTTON_COLOR_YELLOW,                      // DIR_N
