...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_MEDIAPATH ";rp;biospath;bp",                "Emulator/MSForever/roms",      OPTION_STRING,     "path to ROM sets and hard disk images" },
	{ OPTION_HASHPATH ";hash_directory;hash",            "Emulator/MSForever/hash",      OPTION_STRING,     "path to software definition files" },
	{ OPTION_SAMPLEPATH ";sp",                           "Emulator/MSForever/samples",   OPTION_STRING,     "path to audio sample sets" },
	{ OPTION_ARTPATH,                                    "Emulator/MSForever/artwork",   OPTION_STRING,     "path to artwork files" },
	{ OPTION_CTRLRPATH,                                  "Emulator/MSForever/ctrlr",     OPTION_STRING,     "path to controller definitions" },
	{ OPTION_INIPATH,                                    ".;ini;ini/presets",   OPTION_STRING,     "path to ini files" },
	{ OPTION_FONTPATH,                                   ".",         OPTION_STRING,     "path to font files" },
	{ OPTION_CHEATPATH,                                  "Emulator/MSForever/cheat",     OPTION_STRING,     "path to cheat files" },
	{ OPTION_CROSSHAIRPATH,                              "Emulator/MSForever/crosshair", OPTION_STRING,     "path to crosshair files" },
	{ OPTION_PLUGINSPATH,                                "Emulator/MSForever/plugins",   OPTION_STRING,     "path to plugin files" },
	{ OPTION_LANGUAGEPATH,                               "Emulator/MSForever/language",  OPTION_STRING,     "path to UI translation files" },
	{ OPTION_SWPATH,                                     "Emulator/MSForever/software",  OPTION_STRING,     "path to loose software" },

	// output directory options
	{ nullptr,                                           nullptr,     OPTION_HEADER,     "CORE OUTPUT DIRECTORY OPTIONS" },
	{ OPTION_CFG_DIRECTORY,                              "Emulator/MSForever/cfg",       OPTION_STRING,     "directory to save configurations" },
	{ OPTION_NVRAM_DIRECTORY,                            "Emulator/MSForever/nvram",     OPTION_STRING,     "directory to save NVRAM contents" },
	{ OPTION_INPUT_DIRECTORY,                            "Emulator/MSForever/inp",       OPTION_STRING,     "directory to save input device logs" },
	{ OPTION_STATE_DIRECTORY,                            "Emulator/MSForever/sta",       OPTION_STRING,     "directory to save states" },
	{ OPTION_SNAPSHOT_DIRECTORY,                         "Emulator/MSForever/snap",      OPTION_STRING,     "directory to save/load screenshots" },
	{ OPTION_DIFF_DIRECTORY,                             "Emulator/MSForever/diff",      OPTION_STRING,     "directory to save hard drive image difference files" },
	{ OPTION_COMMENT_DIRECTORY,                          "Emulator/MSForever/comments",  OPTION_STRING,     "directory to save debugger comments" },
	{ OPTION_VIDEO_DIRECTORY,                          	 "Emulator/MSForever/video",     OPTION_STRING,     "directory to save/load video files" },
