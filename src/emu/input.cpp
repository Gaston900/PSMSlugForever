...
{
	// FILE *pfile;
	// pfile =fopen("code_to_token.txt","a");
	// fprintf(pfile, "================================ \n");

	// determine the devclass part
	const char *devclass = (*devclass_token_table)[code.device_class()];

	// fprintf(pfile, "Get device class : %s \n",devclass);
	...
	// fprintf(pfile, "Get device index : %s \n",devindex.c_str());
	...
	// if(item != nullptr)
	// 	fprintf(pfile, "Get item index : %s \n",item->token());
	// else
	// {
	// 	fprintf(pfile, "Get item index : null \n");
	// }
	
	// fprintf(pfile, "Get devie code : %s \n",devcode);
	

	// determine the modifier part
	const char *modifier = (*modifier_token_table)[code.item_modifier()];

	// fprintf(pfile, "Get determine modifier : %s \n",modifier);
	...
	// fprintf(pfile, "Get determine itemclass : %s \n",itemclass);
	...
	// fprintf(pfile, "Get str return : %s \n",str.c_str());
...
{
	// FILE *pfile;
	// pfile = fopen("seq_from_tokens.txt","a");
	// fprintf(pfile,"get string %s : \n",string);
