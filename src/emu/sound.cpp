...
void sound_manager::update(void *ptr, int param)
{
	...
	{
		unsigned int samples_this_frame_size = m_samples_this_update;
	        ...
	        if (mame_mixer_wave_cnvnmb != -1)
		{
			...
			if (mame_mixer_wave_cnvnmb & 0x70)
			{
				...
				samples_this_frame_size = ((m_samples_this_update<<16)/mame_mixer_wsr.adder + 256);
			} 
			else
			{
				dst_samples = mame_mixer_wave_cnvbuffer_size / (mame_mixer_dstwfm.channel * (mame_mixer_dstwfm.bitrate/8));
			...
			default:
			case 0:
				wav_wavecnv(mame_mixer_wave_cnvnmb, buf, finalmix, m_samples_this_update);
				break;
			case 1:
				samples_this_frame_size = wav_wavecnv_resize(mame_mixer_wave_cnvnmb, buf, finalmix, m_samples_this_update, &mame_mixer_wsr);
				break;
			case 2:
				samples_this_frame_size = wav_wavecnv_resample(mame_mixer_wave_cnvnmb, buf, finalmix, m_samples_this_update, &mame_mixer_wsre);
				break;
			case 3:
				samples_this_frame_size = wav_wavecnv_stretch(mame_mixer_wave_cnvnmb, buf, finalmix, m_samples_this_update, &mame_mixer_wsre);
				break;
			case 4:
				break;
			case 5:
				break;
			case 6:
				samples_this_frame_size = wav_wavecnv_resample_f(mame_mixer_wave_cnvnmb, buf, finalmix, m_samples_this_update, &mame_mixer_wsre);
				break;
			case 7:
				samples_this_frame_size = wav_wavecnv_stretch_f(mame_mixer_wave_cnvnmb, buf, finalmix, m_samples_this_update, &mame_mixer_wsre);
				break;
			}
