...
{
public:
	menu_command(mame_ui_manager &mui, render_container &container, bool menuless_mode);
	virtual ~menu_command() override;
...
class menu_command_content : public menu_command 
{
public:
	menu_command_content(mame_ui_manager &mui, render_container &container, int param);
	virtual ~menu_command_content() override;
private:	
	virtual void populate(float &customtop, float &custombottom) override;
	virtual void handle() override;
	//virtual void custom_render(void *selectedref, float top, float bottom, float x, float y, float x2, float y2) override;
