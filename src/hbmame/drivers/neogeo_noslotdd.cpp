...
void neogeo_state::init_kof2003hdd()
{
	init_neogeo();
...
ROM_START( svcdd )
	ROM_REGION( 0x600000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "prom", 0x000000, 0x600000, CRC(93855c0b) SHA1(03dd06ff5a11a37990bd0a9531beb44c63de2d91) )
	ROM_DEFAULT_BIOS("console_mode")
...
ROM_START( svcbootdd )
	ROM_REGION( 0x600000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "promb", 0x000000, 0x600000, CRC(f429e90a) SHA1(bc696bfadb8f3d14eb261eb529fcc1e0712b5bf2) )
	ROM_DEFAULT_BIOS("console_mode")
...
ROM_START( svcplusadd )
	ROM_REGION( 0x600000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "prompa", 0x000000, 0x600000, CRC(293219d0) SHA1(aa58bd3c579ecfb68e44762dd8af4d52c5817a4e) )
	ROM_DEFAULT_BIOS("console_mode")
...
ROM_START( svcsplusdd )
	ROM_REGION( 0x800000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "promsp", 0x000000, 0x800000, CRC(a795d685) SHA1(759543fd075df8752582518fd34d0592dee9d035) )
	ROM_DEFAULT_BIOS("console_mode")
...
ROM_START( svcpcbdd )
	ROM_REGION( 0x900000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "promcb", 0x000000, 0x800000, CRC(f58d274c) SHA1(dcdebf8573c303863224a14580a781c7c6271380) )
	ROM_LOAD16_WORD_SWAP( "prom1",  0x800000, 0x100000, CRC(956bac74) SHA1(bf0b121670df23f2cc64302d9f215e7c81187bbb) )
	ROM_DEFAULT_BIOS("console_mode")
...
GAME( 2003, kof2003hdd,   kof2003,  neogeo_noslot,   neogeo, neogeo_state,   init_kof2003hdd, ROT0, "SNK Playmore", "The King of Fighters 2003 (NGH-2710) (Darksoft)", MACHINE_MECHANICAL )
...
GAME( 2003, svcdd,        svc,      neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK Playmore", "SNK vs. Capcom - SVC Chaos (NGM-2690)(NGH-2690) (Darksoft)", MACHINE_MECHANICAL )
GAME( 2003, svcbootdd,    svc,      neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos (bootleg) (Darksoft)", MACHINE_MECHANICAL )
...
GAME( 2003, svcsplusdd,   svc,      neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Super Plus (bootleg) (Darksoft)", MACHINE_MECHANICAL )
GAME( 2003, svcpcbdd,     svc,      neogeo_noslot,   neogeo, neogeo_state,   init_svcpcbdd,   ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos (JAMMA PCB, set 1) (Darksoft)", MACHINE_MECHANICAL )
...
GAME( 2001, vlinerdd,     vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.7a) (Darksoft)", MACHINE_MECHANICAL )
GAME( 2001, vliner7edd,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.7e) (Darksoft)", MACHINE_MECHANICAL )
GAME( 2001, vliner6edd,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.6e) (Darksoft)", MACHINE_MECHANICAL )
GAME( 2001, vliner54dd,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.54) (Darksoft)", MACHINE_MECHANICAL )
GAME( 2001, vliner53dd,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.53) (Darksoft)", MACHINE_MECHANICAL )
...
//GAME( 2000, bangbeands,    bangbead, neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "Visco", "Bang Bead (Neo SD)", MACHINE_MECHANICAL )
...
//GAME( 2002, kf2k2plsnds,   kof2002,  neogeo_noslot,   neogeo, neogeo_state,   init_kof2002dd,  ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg, set 1) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted GFX */
//GAME( 2002, kf2k2plands,   kof2002,  neogeo_noslot,   neogeo, neogeo_state,   init_kof2002dd,  ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg, set 2) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted GFX */
...
//GAME( 2003, kf2k3uplnds,   kof2003,  neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg", "The King of Fighters 2004 Ultra Plus (The King of Fighters 2003 bootleg) (Neo SD)", MACHINE_MECHANICAL ) // zooming is wrong because its a bootleg of the pcb version on a cart
//GAME( 2003, kf2k3plnds,    kof2003,  neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg", "The King of Fighters 2004 Plus / Hero (The King of Fighters 2003 bootleg) (Neo SD)", MACHINE_MECHANICAL ) // zooming is wrong because its a bootleg of the pcb version on a cart
...
//GAME( 2000, kof2000nds,    kof2000,  neogeo_noslot,   neogeo, neogeo_state,   init_kof2000dd,  ROT0, "SNK", "The King of Fighters 2000 (NGM-2570 ~ NGH-2570) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted Code & GFX */
//GAME( 2000, kof2000nnds,   kof2000,  neogeo_noslot,   neogeo, neogeo_state,   init_kof2000dd,  ROT0, "SNK", "The King of Fighters 2000 (Not encrypted) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted GFX */
...
//GAME( 2002, kof2002nds,    kof2002,  neogeo_noslot,   neogeo, neogeo_state,   init_kof2002dd,  ROT0, "Eolith / Playmore", "The King of Fighters 2002 (NGM-2650)(NGH-2650) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted GFX */
//GAME( 2002, kof2002bnds,   kof2002,  neogeo_noslot,   neogeo, neogeo_state,   init_kof2002dd,  ROT0, "bootleg", "The King of Fighters 2002 (bootleg) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2003, kof2003nds,    kof2003,  neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK Playmore", "The King of Fighters 2003 (NGM-2710) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2003, kof2003hnds,   kof2003,  neogeo_noslot,   neogeo, neogeo_state,   init_kof2003hdd,   ROT0, "SNK Playmore", "The King of Fighters 2003 (NGH-2710) (Neo SD)", MACHINE_MECHANICAL )
...
//GAME( 1998, kof98nds,      kof98,    neogeo_noslot,   neogeo, neogeo_state,   init_kof98dd,    ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (NGM-2420) (Neo SD)", MACHINE_MECHANICAL )
...
//GAME( 1998, kof98knds,     kof98,    neogeo_noslot,   neogeo, neogeo_state,   init_kof98dd,    ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (Korean board) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 1998, kof98kands,    kof98,    neogeo_noslot,   neogeo, neogeo_state,   init_kof98dd,    ROT0, "SNK", "The King of Fighters '98 - The Slugfest / King of Fighters '98 - dream match never ends (Korean board 2) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 1999, kof99nds,      kof99,    neogeo_noslot,   neogeo, neogeo_state,   init_kof99dd,    ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (NGM-2510) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted Code & GFX */
//GAME( 1999, kof99ends,     kof99,    neogeo_noslot,   neogeo, neogeo_state,   init_kof99dd,    ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (Earlier) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted Code & GFX */
//GAME( 1999, kof99hnds,     kof99,    neogeo_noslot,   neogeo, neogeo_state,   init_kof99dd,    ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (NGH-2510) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted Code & GFX, crashes going into attract demo */
//GAME( 1999, kof99knds,     kof99,    neogeo_noslot,   neogeo, neogeo_state,   init_kof99dd,    ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (Korean release) (Neo SD)" , MACHINE_MECHANICAL ) /* Encrypted Code & GFX */
...
//GAME( 1995, rbff1kands,    rbff1,    neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK", "Real Bout Fatal Fury / Real Bout Garou Densetsu (Korean release, bug fix revision) (Neo SD)", MACHINE_MECHANICAL )
...
//GAME( 2004, samsh5spnds,   samsh5sp, neogeo_noslot,   neogeo, neogeo_state,   init_samsh5spdd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGM-2720) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2004, samsh5sphnds,  samsh5sp, neogeo_noslot,   neogeo, neogeo_state,   init_samsh5spdd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720) (2nd release, less censored) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2004, samsh5sphonds, samsh5sp, neogeo_noslot,   neogeo, neogeo_state,   init_samsh5spdd, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720) (1st release, censored) (Neo SD)", MACHINE_MECHANICAL )
...
//GAME( 2003, samsho5nds,    samsho5,  neogeo_noslot,   neogeo, neogeo_state,   init_samsho5dd,  ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGM-2700, set 1) (Neo SD)", MACHINE_MECHANICAL )
...
//GAME( 2003, samsho5hnds,   samsho5,  neogeo_noslot,   neogeo, neogeo_state,   init_samsho5dd,  ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGH-2700) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2003, samsho5bnds,   samsho5,  neogeo_noslot,   neogeo, neogeo_state,   init_samsho5bdd, ROT0, "bootleg", "Samurai Shodown V / Samurai Spirits Zero (bootleg) (Neo SD)", MACHINE_MECHANICAL ) // different program scrambling
...
//GAME( 2003, svcnds,        svc,      neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "SNK Playmore", "SNK vs. Capcom - SVC Chaos (NGM-2690)(NGH-2690) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2003, svcbootnds,    svc,      neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos (bootleg) (Neo SD)", MACHINE_MECHANICAL )
...
//GAME( 2003, svcsplusnds,   svc,      neogeo_noslot,   neogeo, neogeo_state,   init_darksoft,   ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Super Plus (bootleg) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2003, svcpcbnds,     svc,      neogeo_noslot,   neogeo, neogeo_state,   init_svcpcbdd,   ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos (JAMMA PCB, set 1) (Neo SD)", MACHINE_MECHANICAL )
...
//GAME( 2001, vliner7ends,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.7e) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2001, vliner6ends,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.6e) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2001, vliner54nds,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.54) (Neo SD)", MACHINE_MECHANICAL )
//GAME( 2001, vliner53nds,   vliner,   neogeo_noctrl,   vliner, neogeo_state,   init_vlinerdd,   ROT0, "Dyna / BrezzaSoft", "V-Liner (v0.53) (Neo SD)", MACHINE_MECHANICAL )
