...
#define MSLUG3RMZ_SPRITES \
    ROM_REGION( 0x4000000, "sprites", 0 ) \
	ROM_LOAD16_BYTE( "256_remix.c1", 0x0000000, 0x800000, CRC(d799f41c) SHA1(d87cda305d054c56197112ba515299883d419bb4) )\
	ROM_LOAD16_BYTE( "256_remix.c2", 0x0000001, 0x800000, CRC(c9725cd0) SHA1(59a0a2778ae35ddcac17fba05a81f3da5eaca1f1) )\
	ROM_LOAD16_BYTE( "256d.c3", 0x1000000, 0x800000, CRC(bfaade82) SHA1(66b07e592c9a9b35567fe463496f8f75c32a7db9) )\
	ROM_LOAD16_BYTE( "256d.c4", 0x1000001, 0x800000, CRC(1463add6) SHA1(4db91b46d6430da272d27d00a6dc0eb25949bea1) )\
	ROM_LOAD16_BYTE( "256_dw01.c5", 0x2000000, 0x800000, CRC(3dd2c01f) SHA1(8485ba8940ae60d0a2a9561d5a82fd5f32452e01) )\
	ROM_LOAD16_BYTE( "256_dw01.c6", 0x2000001, 0x800000, CRC(1ea253a8) SHA1(c3134199eff0dfe47b9c05caea0245ffbee4e8c3) )\
	ROM_LOAD16_BYTE( "256_remix.c7", 0x3000000, 0x800000, CRC(82097fdb) SHA1(04ff6755087df0995c196e8817827fda3b9f9d08) )\
	ROM_LOAD16_BYTE( "256_remix.c8", 0x3000001, 0x800000, CRC(aa7ca14d) SHA1(876ed262200535b82f74e56b64128df23140338b) )
...
ROM_START( mslug3hc06 ) //mslug3sd
	ROM_REGION( 0x500000, "maincpu", 0 )
    // The official file has problems for the emulation that until today I could not fix.
	ROM_LOAD16_WORD_SWAP( "256_hc06_original file.p1", 0x000000, 0x100000, BAD_DUMP CRC(e1e21cc4) SHA1(c70ef18dfe8edbadadff6004508e838b246b88a5) ) //CRC32 SHA1 Official Rom Hack
	// Only the roms are kept even though they don't work
...
ROM_START( mslug3hc10 ) // mslug3gw
	ROM_REGION( 0x500000, "maincpu", 0 )
    // The official file has problems for the emulation that until today I could not fix.	
	ROM_LOAD16_WORD_SWAP( "256_hc10_original file.p1",   0x000000, 0x100000, BAD_DUMP CRC(fafde0b4) SHA1(3eee501ddebda761d93c49cdea135fdf0aa0dc9c) ) //CRC32 SHA1 Official Rom Hack
	// Only the roms are kept even though they don't work	
...
ROM_START( mslug3hc19 ) //mslug3c
	ROM_REGION( 0x500000, "maincpu", 0 )
    // The official file has problems for the emulation that until today I could not fix.
	ROM_LOAD16_WORD_SWAP( "256_hc19_original file.p1", 0x000000, 0x100000, BAD_DUMP CRC(05c99714) SHA1(da2e5b959d9327bce7b244629abaa8784af767a6) ) //CRC32 SHA1 Official Rom Hack
	// Only the roms are kept even though they don't work	
	ROM_LOAD16_WORD_SWAP( "256_hc11.p1", 0x000000, 0x100000, CRC(e575a406) SHA1(fcfab75f53c13353fcdd85293dee5bd71f614bb0) )
...
ROM_START( mslug3hc20 ) //mslug3hcr, mslug3nsj
	ROM_REGION( 0x500000, "maincpu", 0 )
    // The official file has problems for the emulation that until today I could not fix.
    ROM_LOAD16_WORD_SWAP( "256_hc20_original file.p1", 0x000000, 0x100000, BAD_DUMP CRC(f804b927) SHA1(a1a6bcc0fe65416c3ab04f84513da2138515fed0) )
	// Only the roms are kept even though they don't work
...
ROM_START( mslug3dw01 ) //mslug3lw, mslug3nd
	...
	// The official file has problems for the emulation that until today I could not fix.
	ROM_LOAD16_WORD_SWAP( "256_dw01.p1", 0x000000, 0x100000, BAD_DUMP CRC(e2a9e546) SHA1(ba423f82fcad920d4b7366058ab9cd432facfa9e) )
	ROM_LOAD16_WORD_SWAP( "256_dw01.p2", 0x100000, 0x400000, BAD_DUMP CRC(6c4ebec9) SHA1(ccdc6c1d60f2ac03e8545ad18739d4ebc98fc918) )
	// Only the roms are kept even though they don't work
	MSLUG3HD_SFIX_128K
    MSLUG3LW_AUDIO_512K
    MSLUG3LW_YMSND
...
ROM_START( mslug4hc03 ) //mslug4lw
	ROM_REGION( 0x900000, "maincpu", 0 )
    // The official file has problems for the emulation that until today I could not fix.
    ROM_LOAD16_WORD_SWAP( "263_hc03_original file.p1", 0x000000, 0x100000, BAD_DUMP CRC(ad713169) SHA1(51c10dfa1b8fc3b0e7850c71920091dbd91d1ba5) )
	// Only the roms are kept even though they don't work
...
ROM_START( mslug4hc12 ) //mslug4lwq
	ROM_REGION( 0x900000, "maincpu", 0 )
    // The official file has problems for the emulation that until today I could not fix.
    ROM_LOAD16_WORD_SWAP( "263_hc12_original file.p1", 0x000000, 0x100000, BAD_DUMP CRC(9ebe335e) SHA1(7af10e13b84494393c0e32d01e881060236724db) )
	// Only the roms are kept even though they don't work
...
ROM_START( ms5boot )
	ROM_REGION( 0x500000, "maincpu", 0 )
    // The official file has problems for the emulation that until today I could not fix.
    ROM_LOAD16_WORD_SWAP( "268boot_original file.p1", 0x000000, 0x100000, BAD_DUMP CRC(e6d297af) SHA1(5bb3f72ce26e3f46c523b955f425056eb246e855) )
	// Only the roms are kept even though they don't work
...
ROM_START( mslugxhc12 ) //mslugxsc
	ROM_REGION( 0x500000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "250_hc12.p1", 0x000000, 0x100000, CRC(31a59213) SHA1(8c4a07ec65139f9071f00068884dce3f5e6bdb37) )
	ROM_LOAD16_WORD_SWAP( "250_hc12.p2", 0x100000, 0x400000, CRC(80067de1) SHA1(c6d3f4c3f91acc240761a72742774aaf7b53693d) )
    ROM_DEFAULT_BIOS("euro")
    MSLUGX_ROM_FILL
    MSLUGX_SFIXSC_128K
    MSLUGX_AUDIO_128K
...
ROM_START( mslugxhc25 ) //mslug3scb
	ROM_REGION( 0x500000, "maincpu", 0 )
...
// It doesn't work, it causes the game to crash.
GAME( 2023, mslug3dw01,        mslug3,   no_watchdog,   mslughb, neogeo_state,    init_mslug3a,   ROT0, "GOTVG",          "Metal Slug 3 (Last Bullet Remix 2023-03-09)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
// Decrypted And Bootleg
...
GAME( 2023, mslug5hc18,        mslug5,   neogeo_noslot, mslughb, neogeo_state,    init_mslug5hb,  ROT0, "GOTVG",          "Metal Slug 5 (Stone Tortoise Edition 2023-03-09)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2023, mslugxhc12,        mslugx,   neogeo_noslot, mslughb, neogeo_state,    init_mslugx,    ROT0, "GOTVG",          "Metal Slug X (Legendary Last Edition 2023-03-07)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2023, mslugxhc25,        mslugx,   neogeo_noslot, mslughb, neogeo_state,    init_mslugx,    ROT0, "GOTVG",          "Metal Slug X (Legendary Edition 2023-02-13)", MACHINE_SUPPORTS_SAVE )
