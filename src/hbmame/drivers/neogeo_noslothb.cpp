...
#define MSLUG3CQ_SPRITES \
	...
	ROM_LOAD16_BYTE( "256d.c5", 0x2000000, 0x800000, CRC(48ca7f28) SHA1(e903876be5fb4fa582c988d74c6bef1c3b9c7083) )\
	ROM_LOAD16_BYTE( "256d.c6", 0x2000001, 0x800000, CRC(806eb36f) SHA1(a412a9cab80c326733dde7652d1db2a46afb3ebb) )\
	ROM_LOAD16_BYTE( "256_hc27.c7", 0x3000000, 0x800000, CRC(b8e017de) SHA1(fb88f2d12be6e9ea6cec4d5d5b33d828d34c28d3) )\
	ROM_LOAD16_BYTE( "256_hc27.c8", 0x3000001, 0x800000, CRC(def95742) SHA1(be76a3da972ee4dfe9f1f1b41d35fa3027c05c1d) )
...
#define MSLUG4_SFIXSD_128K \
	NEO_SFIX_128K( "263_hc01.s1", CRC(c4f4ed0e) SHA1(bbf31c879d72cc843229b03db01399af98e02f01) )

#define MSPLUS4_SFIX_128K \
    NEO_SFIX_128K( "ms4-s1p.bin", CRC(07ff87ce) SHA1(96ddb439de2a26bf9869015d7fb19129d40f3fd9) )

#define MSLUG4_SFIXHD_128K \
...
#define MSLUG4LWD_YMSND \
	ROM_REGION( 0x1000000, "ymsnd", 0 ) \
	ROM_LOAD( "263lwd.v1", 0x000000, 0x400000, CRC(8cb5a9ef) SHA1(272ad312f8694acf9190ebf48d1c8a5fec73c130) )\
	ROM_LOAD( "263lwd.v2", 0x400000, 0x400000, CRC(94217b1e) SHA1(c468a192e2ec0952a20cfd9e391cf6c12346efb3) )\
	ROM_LOAD( "263lwd.v3", 0x800000, 0x400000, CRC(7616fcec) SHA1(83006094379d0373b967603dcaa1cec69c2f746f) )\
	ROM_LOAD( "263lwd.v4", 0xc00000, 0x400000, CRC(c5967f91) SHA1(874562109c3df9e1fdefbb3970092128aaa31a17) )
...
ROM_START( mslug4lwd )
	ROM_REGION( 0x900000, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "263.p1",    0x000000, 0x100000, CRC(27e4def3) SHA1(a08785e8145981bb6b5332a3b2df7eb321253cca) )
	ROM_LOAD16_WORD_SWAP( "263lwd.p2", 0x100000, 0x800000, CRC(5daa5872) SHA1(3ffa27f363d35809851f18c3865f9ce47220fdc8) )
    MSLUG4_ROM_FILL
    MSLUG4_SFIXHD_128K
	MSLUG4_AUDIOND_128K
	MSLUG4LWD_YMSND
...
GAME( 2021, mslughc02,         mslug,    neogeo_noslot, mslughb, neogeo_state,    init_neogeo,    ROT0, "hack",          "Metal Slug (Random Items Explosives 2021-06-08)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2021, mslug2hc05,       mslug2,   neogeo_noslot, mslughb, neogeo_state,    init_neogeo,    ROT0, "phengzheng",     "Metal Slug 2 (Extraction Green Turbo 2021-09-16)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2021, mslug2hc11,       mslug2,   neogeo_noslot, mslughb, neogeo_state,    init_neogeo,    ROT0, "phengzheng",     "Metal Slug 2 (Extraction Green Turbo Enemies Resetting 2021-09-16)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2022, mslug3hc03,        mslug3,   neogeo_noslot, mslughb, neogeo_state,    init_neogeo,    ROT0, "GOTVG",          "Metal Slug 3 (Komorebi 2022-05-11)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2021, mslug3hc26,        mslug3,   neogeo_noslot, mslughb, neogeo_state,    init_mslug3,    ROT0, "KofKill, Wang Hua, Czk", "Metal Slug 3 (Unity Time! 2021-02-21)" , MACHINE_SUPPORTS_SAVE )
...
GAME( 2019, mslug3b6hc05,      mslug3,   neogeo_noslot, mslughb, neogeo_state,    init_mslug3b6d, ROT0, "hack",           "Metal Slug 6 (Enemy Soldiers Reset 2019-01-02)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2002, mslug4lwd,         mslug4,   neogeo_noslot, mslughb, neogeo_state,    init_neogeo,    ROT0, "Mega / Playmore","Metal Slug 4 (Last Bullet Remix, Decrypted C)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2021, mslug4rmd01,       mslug4,   neogeo_noslot, mslughb, neogeo_state,    init_mslug4hb,  ROT0, "Team Remix (Gaston90, Creamymami[EGCG] And I love Nimes)",                 "Metal Slug 4 (Revised Multi-Function Enemies Resetting Big Heavy Machine Gun Extreme MegaMods Edition 2021-11-01)", MACHINE_SUPPORTS_SAVE )
