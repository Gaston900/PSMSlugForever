...
// OS X can be trusted to have working hardware OpenGL, so default to it on for the best user experience
	...
	{ OSDOPTION_GLSLPATH,                     "Emulator/MSForever/glsl", OPTION_STRING,    "path to glsl shader files" },
	...
	{ OSDOPTION_BGFX_PATH,                    "Emulator/MSForever/bgfx",  OPTION_STRING, "path to BGFX-related files" },
